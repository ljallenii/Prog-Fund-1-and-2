...
def main():
    ...
    # Loops again unless user inputs '4' to quit. Also checks to make sure a valid option is chosen.
    else:
        print("MENU:\n\t1. Make Change\n\t2. High Card\n\t3. Deal Hand\n\t4. Quit\n")
        option = int(input("Please choose an option (1, 2, 3, or 4) to contiue: "))       
...
# Deal Hand Function
def DealHand():
    card1 = display_face_value()
    card2 = display_face_value()
    card3 = display_face_value()
    card4 = display_face_value()
    card5 = display_face_value()
